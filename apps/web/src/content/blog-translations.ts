...
const tr: Record<string, Omit<LocalizablePost, "slug">> = {
  "how-to-use-ai-coding-assistant": {
    ...
    content: [
      ...
      { type: "paragraph", text: "İlk çalıştırma sihirbazı, sağlayıcı seçimi ve API anahtarı yapılandırması boyunca size rehberlik eder." }, { type: "heading", text: "En İyi Uygulamalar" }, { type: "paragraph", text: "Yapay zekâ kodlama asistanınızdan en iyi sonucu almak için:" },
  ...
  "claude-code-vs-aurict": {
    ...
    content: [
      ...
      { type: "list", items: ["Anthropic", "OpenAI", "Google", "OpenRouter", "xAI", "Azure OpenAI", "AWS Bedrock", "Ollama", "OpenCode"] },
  ...
  "mcp-model-context-protocol": {
    ...
    content: [
      ...
      { type: "heading", text: "Aurict'in MCP Desteği" }, { type: "paragraph", text: "Aurict, claude_desktop_config.json dosyanızı otomatik okur. Claude Desktop için yapılandırdığınız her MCP sunucusu Aurict ile de hemen çalışır." }, { type: "code", language: "json", text: "{\n  \"mcpServers\": {\n    \"postgres\": {\n      \"command\": \"npx\",\n      \"args\": [\"-y\", \"@modelcontextprotocol/server-postgres\"],\n      \"env\": {\n        \"DATABASE_URL\": \"postgresql://localhost:5432/mydb\"\n      }\n    }\n  }\n}" },
