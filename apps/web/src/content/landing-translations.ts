...
export const whyItemsTr: Triple[] = [
  ...
  ["04", "Açık ve genişletilebilir.", "Kendi MCP sunucularınızı, özel komutlarınızı ve paylaşılan ekip becerilerinizi getirin. Mevcut yapılandırmanız ilk çalıştırmada işler — hiçbir şey özel bir bulutun ardına kilitlenmez."],
]
...
export const capabilityItemsTr: Triple[] = [
  ...
  ["mcp istemcisi", "Mevcut yapılandırmanızı kullanın; kullandığınız her MCP sunucusu — dosya sistemi, GitHub, Postgres, tarayıcı — anında çalışır.", "oklch(0.72 0.15 145)"],
...
export const installStepsTr: Quad[] = [
  ...
  ["03 · yapılandır", "# sağlayıcı, anahtar, model", "Etkileşimli kurulum — güvenlik araçları siz açana kadar kapalı.", "var(--accent)"],
...
export const faqsTr: Pair[] = [
  ...
  ["Mevcut MCP sunucularımı kullanabilir miyim?", "Evet — Aurict'i mevcut MCP yapılandırmanıza yönlendirin; halihazırda kurulu her sunucu göç gerektirmeden anında çalışır."],
]
