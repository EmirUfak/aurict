...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Aurict is designed to work with existing MCP-style workflows so developers can bring the tools they already use into the terminal assistant runtime." },
