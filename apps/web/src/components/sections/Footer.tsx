    ...
    <footer className={styles.footer}>
      <div className={styles.frame}>
        ...
        <div className={styles.columns}>
          <FooterColumn title={t("product")} links={[[t("terminalAgent"), "/terminal-agent"], [t("capabilities"), "/#capabilities"], ["Bondley.one", "https://bondley.one"], [t("roadmap"), "/roadmap"], [t("compare"), "/compare"], [t("docs"), "/docs"], [t("changelog"), "/changelog"]]} />
