    ...
    <div data-screen-label="Nav" style={{ position: "sticky", top: 0, zIndex: 20, backdropFilter: "blur(10px)", background: "color-mix(in oklch, var(--bg) 82%, transparent)", borderBottom: "1px solid oklch(1 0 0 / .07)" }}>
      <div className="landing-shell landing-nav-inner">
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <BrandMark compact />
          <span className="mono" style={{ fontSize: 10.5, padding: "4px 7px", borderRadius: 6, border: "1px solid var(--border)", background: "oklch(1 0 0/.06)", color: "oklch(0.55 0.01 75)" }}>v1.1.6 · AGPLv3</span>
        </div>
